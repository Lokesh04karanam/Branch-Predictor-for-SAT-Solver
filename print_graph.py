...
policies = ['bimodal','hashed_perceptron','gshare','tage','ltage']
plotdata = []
...
bar5 = plt.bar(ind+4*width, policywiseData[4][0], width, color = '#FFA500')

plt.xlabel("Different branch predictors")
plt.ylabel("IPC values")
plt.legend( (bar1,bar2,bar3,bar4,bar5), ('bimodal','hashed_perceptron','gshare','tage','ltage') )
...
bar5 = plt.bar(ind+4*width, policywiseData[4][1], width, color = '#FFA500')
